...
void systemResetCallback()
{
  ...
  for (byte i=0; i < TOTAL_PINS; i++) {
    if (IS_PIN_ANALOG(i)) {
      ...
      //setPinPropCallback(i, ANALOG, ""); // /!\ do not be commented, just for a test
    } else {
      // sets the output to 0, configures portConfigInputs
      //setPinPropCallback(i, OUTPUT, ""); // /!\ do not be commented, just for a test
    }
  }
